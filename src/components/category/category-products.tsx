            ...
            <section id="category-product" className="grid-container | flow-spacing-3">
                <div className="category-product-grid">
                    ...
                    <div className="flex flex-col justify-center items-center lg:items-start">
                        <span className={`overline-orange | pb-8 max-w-md text-center lg:text-left ${itemData.new ? '' : 'hidden'}`}>New Product</span>
                        <h2 className="h2-dark | pb-8 max-w-md text-center lg:text-left">{name}</h2>
                        <p className="body-text-alt | pb-8 max-w-md text-center lg:text-left">{description}</p>
                        <Link

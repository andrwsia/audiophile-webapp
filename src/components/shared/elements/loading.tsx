...
export default function LoadingScreen() {
    return (
        <section id='loading-screen' className='grid-container flow-spacing-3'>
            <div className='grid-container_grid-area | mt-36 sm:mt-48'>
                <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-36">
                ...
                <div className='mt-24 lg:mt-32'>
                    <div className='mx-auto grid grid-cols-1 lg:grid-cols-5 gap-16 md:gap-20 lg:gap-32'>
